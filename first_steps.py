...
a = 976.543 #datatype is float
b = 345 # datatype is int
v_1 = a-b # datatype is float
print(v_1) 
...
print ("Pi rounded to the first {} decimals is: {}" .format(10, round(pi,n)))
# ------------------------------------
